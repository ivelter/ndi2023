  ...
  return (
    <Degrade color={all["marron-clair"]} id={5}>
      <div className={base.centerDiv}>
        <h1>
          {" "}
          Le <b>changement climatique</b> est une réalité qui n'est plus à{" "}
          <b className={base.redText}> démontrer </b>.
        </h1>
        <b className={base.leftText}>
          {" "}
          <b className={base.souligner}>
            {" "}
            Les scientifiques du GIEC sont catégoriques :
          </b>{" "}
          <br></br>"les activités humaines, principalement par le biais des
